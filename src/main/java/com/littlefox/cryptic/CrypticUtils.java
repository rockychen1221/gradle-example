...
public class CrypticUtils {
    ...
    private static CrypticUtils crypticUtils;
     ...
     * @return
     */
    public static CrypticUtils getInstance(){
        if(crypticUtils == null){
            // 当需要创建的时候在加锁
            synchronized(CrypticUtils.class) {
                if (crypticUtils == null) {
                    crypticUtils = new CrypticUtils();
                    init();
                }
            }
        }
